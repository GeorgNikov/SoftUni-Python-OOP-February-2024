...
class NauticalCatchChallengeApp:
    ...
    def dive_into_competition(self, diver_type: str, diver_name: str):
        ...
        if diver_name in self.divers_names:
            return f"{diver_name} is already a participant."

        new_diver = self.VALID_DIVERS[diver_type](diver_name)
        self.divers.append(new_diver)
        self.divers_names.add(diver_name)
    ...
    def swim_into_competition(self, fish_type: str, fish_name: str, points: float):
        ...
        if fish_name in self.fish_names:
            return f"{fish_name} is already permitted."

        new_fish = self.VALID_FISH[fish_type](fish_name, points)
        self.fish_list.append(new_fish)
        self.fish_names.add(fish_name)

        return f"{fish_name} is allowed for chasing as a {fish_type}."

    def chase_fish(self, diver_name: str, fish_name: str, is_lucky: bool):
        diver = self._get_diver_by_name(diver_name)
        if not diver:
